...
module.exports = {
  ...
  networks: {
    ...
    development: {
      host: "127.0.0.1", /*Set to our localhost*/
    ...
    rinkeby: {
      provider: function() {
        ...
        //program cabbage endless strategy green common cotton universe letter time ticket town
        //glad belt dirt age derive umbrella weird gospel park pottery hamster best
